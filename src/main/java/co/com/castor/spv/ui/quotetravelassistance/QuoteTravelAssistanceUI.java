...
public class QuoteTravelAssistanceUI {
    ...
    public static final Target BTN_DAY_ARRIVAL =Target.the ("Select arrival day").located(By.xpath(new CalculateDate().Calculate_d1(3)));
    public static final Target BTN_ADD_PERSON =Target.the ("Add person Button").located(By.xpath("/html/body/div[4]/div[2]/div/div/div/div/div/div[2]/button[2]/i"));
